<script lang="ts">
	...
	let contentHtml = $state(data.page.content);
</script>
...
<div class="flex flex-col gap-6 max-w-4xl mx-auto w-full px-4 lg:px-6 py-6">
	<div class="flex items-center gap-4">
		...
		<div>
			<h2 class="text-2xl font-bold tracking-tight">Edit Halaman</h2>
			<p class="text-muted-foreground">Perbarui konten halaman statis.</p>
		</div>
	</div>
