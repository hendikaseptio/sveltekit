...
<div class="flex flex-col gap-6 max-w-2xl mx-auto w-full px-4 lg:px-6 py-6">
	<div class="flex items-center gap-4">
		...
		<div>
			<h2 class="text-2xl font-bold tracking-tight">Edit Menu</h2>
			<p class="text-muted-foreground">Perbarui item navigasi.</p>
		</div>
	</div>
		...
		<Card.Root>
			<Card.Content class="pt-6 space-y-6">
				<div class="space-y-2">
					...
					<Input id="label" name="label" bind:value={label} required />
				</div>
